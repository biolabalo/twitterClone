...
const TweetComponent = ({ tweetsOnTime }) => {
    ...
    return (
        tweetsOnTime.map( ()=> <div className="stream-container">
        <div className="stream">
          <div className="context-container">


          <div className="css-1dbjc4n r-17bb2tj r-1muvv40 r-127358a r-1ldzwu0" style={{height: "26px;", width: "26px"}}>
            <svg height="100%" viewBox="0 0 32 32" width="100%">
                <circle cx="16" cy="16" fill="none" r="14" stroke-width="4" style="stroke: rgb(29, 161, 242); opacity: 0.2;">
                 </circle><circle cx="16" cy="16" fill="none" r="14" stroke-width="4" style="stroke: rgb(29, 161, 242); stroke-dasharray: 80; stroke-dashoffset: 60;">
                 </circle>
            </svg>
          </div>
